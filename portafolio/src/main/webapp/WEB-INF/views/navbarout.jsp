			...
			<div class="collapse navbar-collapse ms-auto" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item active"><a class="nav-link"
						href="/portafolio/landing">Inicio</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/portafolio/series">Series</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/portafolio/podcast">Podcast</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/portafolio/about">Sobre nosotros</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/portafolio/contacto">Contacto</a></li>
					<li class="nav-item"><a class="nav-link btn btn-purple me-2"
						href="/portafolio/login">Iniciar Sesión</a></li>
					<li class="nav-item"><a class="nav-link btn btn-purple"
						href="/portafolio/registro">Registro</a></li>
				</ul>
			</div>
		</div>
	</nav>
